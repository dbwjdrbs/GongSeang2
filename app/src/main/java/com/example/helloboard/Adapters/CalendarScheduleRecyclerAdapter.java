...
import com.example.helloboard.models.CalendarScheduleRecyclerItem;
import com.example.helloboard.CalendarScheduleShowActivity;
...
public class CalendarScheduleRecyclerAdapter extends RecyclerView.Adapter<CalendarScheduleRecyclerAdapter.ViewHolder>{
    ...
    public CalendarScheduleRecyclerAdapter(int year, int month, int day){
        this.year = year;
        this.month = month;
        this.day = day;
    }
