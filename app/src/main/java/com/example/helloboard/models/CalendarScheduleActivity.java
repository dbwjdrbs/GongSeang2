...
public class CalendarScheduleActivity extends AppCompatActivity {
    ...
    private com.example.helloboard.models.CalendarScheduleRecyclerAdapter adapter_calendar_schedule;
    ...
    private void btn_clicked(){
        btn_calenadar_schedule_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CalendarScheduleActivity.this, com.example.helloboard.CalendarScheduleAddActivity.class);
    ...
    private void init_rv(){
        ...
        adapter_calendar_schedule = new com.example.helloboard.models.CalendarScheduleRecyclerAdapter(year, month, day);
