...
public class Test_Info_Local_Area_Chungcheong extends AppCompatActivity {
    private static String TAG = "MyApplication_Test_Info_Local_Area_Chungcheong";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_info_local_area_chungcheong);
        ...
        //스피너 정의
        final String[] local_category_list = {"충청도 9급 지방직(일행직) 경쟁률/합격선",
                "충청도 9급 지방직(사복직) 경쟁률/합격선",
                "충청도 9급 지방직(세무직) 경쟁률/합격선"};
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                if (position == 0) {
                    ...
                    GetData_Chungcheong task = new GetData_Chungcheong();
                    task.execute("http://ad66025.dothome.co.kr/getjson_Chungcheong_general_ad.php");
                }
                if (position == 1) {
                    mTextView.setText(null);
                    GetData_Chungcheong task = new GetData_Chungcheong();
                    task.execute("http://ad66025.dothome.co.kr/getjson_Chungcheong_social_welfare.php");
                }
                if (position == 2) {
                    mTextView.setText(null);
                    GetData_Chungcheong task = new GetData_Chungcheong();
                    task.execute("http://ad66025.dothome.co.kr/getjson_Chungcheong_tax.php");
                }
            }
    ...
    private class GetData_Chungcheong extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(Test_Info_Local_Area_Chungcheong.this,
