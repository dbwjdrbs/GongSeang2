...
public class ImageActivity extends AppCompatActivity {
    ...
    String filename = "freeboard" + mStore.collection(FirebaseID.documentId)
            .document(mAuth.getCurrentUser().getUid()) + ".jpg";  //ex) profile1.jpg 로그인하는 사람에 따라 그에 식별값에 맞는 프로필 사진 가져오기
